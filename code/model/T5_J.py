...
def train(args):
    ...
    while step < args.no_train_steps:
        ...
        for _, (inp_batch, out_batch, switch_batch) in enumerate(tqdm(dataloader)):
            # if count <= 2:
            #     print(len(list(inp_batch)),'the inp_batch, out batch, and switch_batch is \
            #     isisiisisisiisisiisiisisAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA\
...
sentence_f1.71.16 document_f1.74.65_re_bestBCE_Sum_weight30000/dev_fin.jsonl', type=str)
    parser.add_argument('-asp_test_file', default='/home/jade/untextsum/data/\
allCampusmin60max120summary_source_num5review_source_num60keywords5/\
Sentiment_filtered7_BCE_Sum_weightstep.24000 average_loss.421.54 \
sentence_f1.71.16 document_f1.74.65_re_bestBCE_Sum_weight30000/test_fin.jsonl', type=str)
    parser.add_argument('-data_dir', default='/home/jade/untextsum/data', type=str)
    parser.add_argument('-mil_data_dir', default='Sentiment_filtered7_BCE_Sum_weightstep.24000 \
average_loss.421.54 sentence_f1.71.16 document_f1.74.65_re_bestBCE_Sum_weight30000', type=str)
